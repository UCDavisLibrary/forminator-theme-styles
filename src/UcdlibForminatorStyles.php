...
/**
 * @description This class is used to apply UCD branded styles to Forminator forms.
 * You will likely inherit from this class and then add a wp_enqueue_style call to your constructor to load the stylesheet
 */
class UcdlibForminatorStyles {
  ...
  /**
   * @description removes the "Style" options from the form settings page
   */
  ...
  /**
   * @description forces the form style to be "none" when editing a form
   */
  ...
  /**
   * @description styles the submit button
   */
  ...
  /**
   * @description styles the consent box
   */
  ...
  /**
   * @description converts html string to a DOMDocument
   */
